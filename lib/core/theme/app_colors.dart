...
class AppColors {
  ...
  static const Color splashTitleColor = Color(0xff3B2A1A);
  static const Color splashSubtitleColor = Color(0xff4A3728);
  static const Color splashCartBadge = Color(0xff3D7A3A);
  static const Color splashIconCircle = Color(0x33FFFFFF);
  static const Color splashDashedBorder = Color(0x55FF7A2F);
